...
Foi adicionado a cobertura completa de testes de integração para todos os endpoints transacionais relacionados às operações de carteira.
...
Para executar a suíte de testes de integração (que usa o Prisma gerando um schema dinâmico em paralelo para os testes):
