...
describe('TransferUseCase', () => {
  ...
  it('should transfer money successfully between wallets', async () => {
    ...
    walletRepoMock.findById.mockResolvedValueOnce(sourceWallet); // first call: source
    walletRepoMock.findById.mockResolvedValueOnce(targetWallet); // second call: target
